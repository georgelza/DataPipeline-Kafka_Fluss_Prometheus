...
def configparams():
    ...
    config_params["SCHEMAREGISRY"]      = os.environ["KAFKA_SCHEMAREGISRY"]
    config_params["TOPIC"]              = os.environ["KAFKA_TOPIC_NAME"]
    config_params["MODE"]               = int(os.environ["KAFKA_MODE"])
    config_params["BATCH_SIZE"]         = int(os.environ["KAFKA_BATCH_SIZE"])
